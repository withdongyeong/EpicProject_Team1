...
public class FastMonsterController : MonoBehaviour, IMonster
{
    /// <summary>
    /// 몬스터 이동 속도 (빠름)
    /// </summary>
    ...
    /// 추적 사거리
    /// </summary>
    private float chaseRange = 70000f;
    ...
    private void StartChargeAttack()
    {
        ...
        Debug.Log("Fast monster started charge attack!");
    }
    ...
    private void EndChargeAttack()
    {
        ...
        Debug.Log("Fast monster finished charge attack!");
    }
    ...
    private void Attack()
    {
        ...
        if (playerController != null)
        {
            ...
            Debug.Log($"Fast monster attacked player for {attackDamage} damage!");
        }
    }
    ...
    public void TakeDamage(int damage)
    {
        ...
        Debug.Log($"Fast monster took {damage} damage. Current Health: {currentHealth}");
    ...
    private void Die()
    {
        ...
        {
            Core.GameManager.Instance.MonsterDied();
        }
