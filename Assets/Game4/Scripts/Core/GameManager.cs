...
public class GameManager : MonoBehaviour
{
    ...
    /// 플레이어 참조
    /// </summary>
    private Character.Player.PlayerController player;
    ...
    private void FindAndResetPlayer()
    {
        ...
        Character.Player.PlayerController[] allPlayers = FindObjectsOfType<Character.Player.PlayerController>(true);
        ...
        else
        {
            ...
            if (playerObj != null)
            {
                player = playerObj.GetComponent<Character.Player.PlayerController>();
                if (player != null)
                {
                    player.ResetPlayer();
