...
public class TileBuilder
{
        ...
        foreach (TilePlacementData placementData in placedTiles)
        {
            ...
            if (itemData != null)
            {
                ...
                if (tilePrefab != null)
                {
                    ...
                    GameObject tileObj = TileObject.Instantiate(tilePrefab, centerPos, Quaternion.identity);
    ...
    private void CreateHighlightTile(GridSystem gridSystem, int gridX, int gridY, Color tileColor)
    {
        if (_highlightTilePrefab != null)
        {
            ...
            GameObject highlight = TileObject.Instantiate(_highlightTilePrefab, worldPos, Quaternion.identity);
